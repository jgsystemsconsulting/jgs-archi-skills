...
> Machine appends DRAFT seeds and may flip DRAFT (or leftover APPROVED) to IN-WORK to DONE.
> Only humans write APPROVED / REJECTED / DEFERRED.

## SEED-001: Orchestrator skill elicits architectural intent (problem...
- Status: DONE
- Priority: 5
- Source: machine
- Vision link: OBJ-1
- Evidence: VISION.md OBJ-1
- Argument: Deliver OBJ-1 as written. Drafted mechanically by classify from an uncovered objective; edit or reject before review.
- Est: M     Risk: M


## SEED-002: Viewpoint selection is grounded in the ArchiMate viewpoint...
- Status: DONE
- Priority: 5
- Source: machine
- Vision link: OBJ-2
- Evidence: VISION.md OBJ-2
- Argument: Deliver OBJ-2 as written. Drafted mechanically by classify from an uncovered objective; edit or reject before review.
- Est: M     Risk: M
