...
Model the **technology** concern set: Nodes, devices, system software, networks, artifacts, and physical equipment hosting applications.
...
- `archimate://recipes/technology-deployment`
...
1. Restate layer scope and target viewpoints (Technology / deployment / physical views).
...
4. Prefer types appropriate to the **technology** layer per MCP reference resources.
...
```markdown
## Specialist Result: archi-technology-physical
